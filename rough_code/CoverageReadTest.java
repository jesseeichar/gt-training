...
public class CoverageReadTest {
    ...
    @Test
    public void readLyonImage() throws IOException, TransformException, FactoryException {
        File bogota = new File("E:\\GeographicData\\geotiff\\bogota.tif");
//        File lyonImage = new File("E:\\Google Drive\\Training\\resources\\image.tif");
...
//        GeoTiffFormat.BACKGROUND_COLOR
        ...
        final GridCoverage2D renderedView = sourceCoverage.view(ViewType.RENDERED);
//        ImageIO.write(renderedView.getRenderedImage(), "png", new File("bogota_rendered.png"));
//
...
//        ImageIO.write(cropped.view(ViewType.RENDERED).getRenderedImage(), "png", new File("bogota_rendered_cropped.png"));
//
//        final GridCoverage2D wgs63Coverage = (GridCoverage2D) Operations.DEFAULT.resample(sourceCoverage, DefaultGeographicCRS.WGS84);
//        ImageIO.write(wgs63Coverage.view(ViewType.RENDERED).getRenderedImage(), "png", new File("wgs63Coverage.png"));
//
//        double centerx = renderedView.getGridGeometry().getGridRange2D().getCenterX();
//        double centery = renderedView.getGridGeometry().getGridRange2D().getCenterY();
...
//        ImageIO.write(rotated.view(ViewType.RENDERED).getRenderedImage(), "png", new File("rotated.png"));
        ...
        ImageIO.write(clipped.view(ViewType.RENDERED).getRenderedImage(), "png", new File("bogota_clipped.png"));
    }
